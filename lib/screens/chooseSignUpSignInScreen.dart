  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        // decoration: BoxDecoration(
        //     gradient: LinearGradient(stops: [0.75, 1],
        ...
        child: Container(
          ...
          child: Center(
            child: Column(
              children: [
                Image.asset('assets/partner_signin_logo.png', scale: 8),
                // CircleAvatar(
                //   radius: 55,
                ...
                /* Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(color: AppColors.primary, fontSize: 22, fontWeight: FontWeight.w100),
                  ),
                ),*/
                GestureDetector(
                  onTap: () {
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    width: MediaQuery.of(context).size.width - 50,
                    child: Center(
                      child: Text(AppLocalizations.of(context).btnSignUp,
                          style: TextStyle(
                              color: AppColors.colorOnPrimary,
                              fontWeight: FontWeight.bold,
                              fontSize: 15)),
